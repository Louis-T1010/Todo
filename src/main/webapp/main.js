...
function addNewCategory(){
    ...
    setTimeout(function() {
        newCategoryInput.classList.add("visibleNC");
    }, 100);
...
function taskDisplay(){
    ...
    if(tasksSize.value === "0" && completedTasksSize.value === "0"){
        var label = document.createElement("label");
        ...
        addGif();
        console.log(tasksSize.value, completedTasksSize.value);
    }
}
...
function addGif(){
    ...
    image.src = "media/clear-arrow.gif";
