    ...
    <body>
        <div class="today" style="height: 100%;">
            <div id="todays-tasks-form" style="height: auto;">
                ...
                List<Task> tasks = (List<Task>) session.getAttribute(" tasks"); List<Task> completedTasks = (List<Task>
                        ) session.getAttribute("completedTasks");
                        ...
                        <% System.out.println("reached line 32"); %>
                                        ...
                                        <form id="task-form" action="complete" method="post">
                                            <form id="task-p-form" action="complete" method="post">
                                                <div class="task-display">
                                                    ...
                                                    <button id="complete-task" type="submit"
                                                        class="task-buttons">Complete</button>
                                        ...
                                        <% } } else { %>
                                            ...
                                            <% } %>
                                                <% System.out.println("reached line 54"); %>
                                                    ...
                                                    <% userId=(int) session.getAttribute("UserId"); tasks=(List<Task>)
                            ...
                            <div id="completed" class="tasks" id="complete">
                                <% System.out.println("reached line 63"); %>
                                    <h1>Completed</h1>
                                    <% if (completedTasks !=null){ for (Task completedTask : completedTasks) { %>
                                        <form id="completed-task-form" action="undo" method="post">
                                            <div class="task-display">
                                                ...
                                                <input type="hidden" name="taskName" id="taskName"
                                                    value="<%= completedTask.getTaskName() %>">
                                                <form id="duplicate-task-form" action="duplicate" method="post">
                                                    <button id="duplicate" type="submit"
                                                        class="task-buttons">Duplicate</button>
                                                    <input type="hidden" name="taskName" id="taskName"
                                                        value="<%= completedTask.getTaskName() %>">
                                                </form>
                                            </div>
